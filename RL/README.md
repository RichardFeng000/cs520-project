...
```bash
python3 RL/traditional_baseline.py path/to/observation.json
python3 RL/rl_q_learning.py --episodes 12000 --output RL/rl_q_table.json --js-output RL/rl_model.generated.js
...
- `RL/rl_model.generated.js` is automatically embedded into `pacman.js` by `pacman/build.sh` when the file exists.
